...
+----------------------+------------------------------------------------------+
| ``rpi gpio``         | GPIO pin number.                                     |
|                      |                                                      |
|                      | **ONLY BCM/SOC NUMBERING IS SUPPORTED**              |
+----------------------+------------------------------------------------------+
| ``rpi chip``         | LED type, can be ``WS2811``, ``WS2812``, ``WS2812B``,|
|                      | ``SK6812``, or ``SK6812W``.                          |
|                      |                                                      |
|                      | *Optional, default* ``WS2812B``.                     |
+----------------------+------------------------------------------------------+
| ``rpi frequency``    | **DO NOT CHANGE THIS UNLESS YOU KNOW WHAT YOU ARE    |
|                      | DOING**                                              |
|                      |                                                      |
...
+----------------------+------------------------------------------------------+
| ``rpi invert``       | Invert the data signal to the LEDs, this is useful   |
